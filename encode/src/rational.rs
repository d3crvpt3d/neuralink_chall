...
impl BigRational {
  ...
  //creating a new instance of BigRational
  pub fn new(numerator: BigUint, denominator: BigUint) -> BigRational{
    BigRational{
      numerator,
      denominator,
    }
  ...
  pub fn as_equal_denominator(&self, rhs: &Self) -> (BigRational, BigRational){
  ...
  //changes numerator of BigRational with bigger denominator
